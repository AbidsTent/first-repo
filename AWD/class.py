...
Actual data: http://py4e-data.dr-chuck.net/regex_sum_2221348.txt 
(There are 77 values and the sum ends with 726)
...
that random numbers are inserted throughout the text. Here is a sample of the output 
you might see:
...
def maxx(lis):
    ...
    for i in lis:
        liss.append(int(i))
    return liss
fname = open(input("Enter file name:") or "actual.txt")
maxr=list()
total=0
for line in fname:
    line=line.rstrip()
